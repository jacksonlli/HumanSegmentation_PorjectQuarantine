...
def resnet50C4(pretrained=False, num_classes=None):
    ...
    if pretrained:
        pretrain_file = './pose2seg/imagenet_pretrain/resnet50_from_modelzoo.pth'
        if not os.path.exists(pretrain_file):
            os.makedirs("./pose2seg/imagenet_pretrain")
...
def resnet101(pretrained=False, num_classes=None):
    ...
    if pretrained:
        pretrain_file = './pose2seg/imagenet_pretrain/resnet101_from_modelzoo.pth'
        if not os.path.exists(pretrain_file):
            os.makedirs("./pose2seg/imagenet_pretrain")
